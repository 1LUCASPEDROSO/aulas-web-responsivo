require={"baseUrl":"http://localhost/rede-social/cache/1682434392/default/","paths":{"cropperjs":["http://localhost/rede-social/cache/1682434392/default/cropperjs/cropper.min"],"jquery-cropper/jquery-cropper":["http://localhost/rede-social/cache/1682434392/default/jquery-cropper/jquery-cropper.min"]},"shim":{"jquery.ui.autocomplete.html":{"deps":["jquery-ui/widgets/autocomplete"]},"jquery-ui/widgets/sortable":{"deps":["elgg/touch_punch"]},"ckeditor/ckeditor":{"exports":"CKEDITOR"},"jquery.ckeditor":{"deps":["jquery","ckeditor/ckeditor"],"exports":"jQuery.fn.ckeditor"}},"waitSeconds":20};require.onNodeCreated=function(node,config,module,path){module=module+'.js';if(elgg.data.sri&&elgg.data.sri[module]){node.setAttribute('integrity',elgg.data.sri[module]);node.setAttribute('crossorigin','anonymous')}};
